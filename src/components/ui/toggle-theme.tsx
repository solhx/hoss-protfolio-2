	...
	return (
		<>
			<div
				...
				onClick={toggleTheme}
				className={cn(
					'p-2 rounded-full transition-colors duration-300 absolute inset-0 cursor-pointer flex items-center justify-center',
					className,
				)}
				{...props}
			>
				{isDark ? (
					<Sun className='text-neutral-500 dark:text-neutral-300' />
				) : (
